...
def get_args():
    ...
    parser.add_argument('--savepath', type=str, default="/devdata/home/homefun/weights/Exdark_CAM_VGG")
    # 修改说明：建议layer参数传入字符串，例如 '543' 代表融合 VGG 的 Block 5, 4, 3
    parser.add_argument('--layer', type=str, default='542', help="Layers to fuse, e.g. 543 for Block 5,4,3")
...
def get_model(resume_path=""):
    ...
    model.classifier[6] = nn.Linear(num_features, 12)
...
if __name__ == '__main__':
    ...
    resume = os.path.join(args.path, r"weights/coco_cam/exdark_loss_vgg_20260227190410/best_acc.pth")
    ...
    val_txt_path = os.path.join(args.path, "weights/coco_cam/exdark_val_with_box.txt")
