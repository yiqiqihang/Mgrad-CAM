...
def get_args():
    ...
    parser.add_argument('--savepath', type=str, default="/devdata/home/homefun/weights/Exdark_CAM")
...
class start():
    ...
    def __init__(self, start_: int, end_: int, csv_save_path: str,
                 ...
                 num_workers: bool = 1,
                 val_txt: str = r"/devdata/home/homefun/weights/coco_cam/exdark_val_with_box.txt"):
...
if __name__ == '__main__':
    ...
    # batch_size = 32
    layer = args.layer
    resume = os.path.join(args.path, r"weights/coco_cam/exdark_loss_20250911085934/best_acc.pth")
    ...
    work = start(0, 2500, os.path.join(save_path, 'record.csv'),
                 ...
                 val_txt=os.path.join(args.path, "weights/coco_cam/exdark_val_with_box.txt"))
