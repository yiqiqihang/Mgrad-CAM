...
def get_args():
    ...
    parser.add_argument(
        '--resume',
        type=str,
        default="/devdata/home/homefun/weights/coco_cam/coco_loss_vgg_20260228042618/best_acc.pth")
...
if __name__ == '__main__':
    ...
    # target_layers = [model.features, model.features[23]]
    # target_layers = [model.features[23], model.features[16]]
    # target_layers = [model.features, model.features[23], model.features[16]]
    ...
    layer = 0
    if target_layers == [model.features]:
        layer = 5
    elif target_layers == [model.features, model.features[21], model.features[9]]:
        layer = 542
